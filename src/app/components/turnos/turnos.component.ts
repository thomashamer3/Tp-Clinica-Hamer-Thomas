...
@Component({
  selector: 'app-turnos',
  standalone: true,
  imports: [MatCard, MatCardTitle, ReactiveFormsModule, MatProgressSpinnerModule, MatTableModule, CommonModule, MatIcon, MatPaginator, DoctorPipe, EncuestaComponent, HistoriaClinicaComponent, FechasPipe],
...
export class TurnosComponent {
  ...
  constructor(private firestore:FirestoreService,private formBuilder :FormBuilder,
    public dialog: MatDialog,private auth: FirebaseAuthService){
  }
