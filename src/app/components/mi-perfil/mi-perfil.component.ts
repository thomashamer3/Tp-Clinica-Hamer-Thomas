...
import { AbstractControl, FormBuilder, ValidatorFn, Validators, ReactiveFormsModule, FormGroup } from '@angular/forms';
...
@Component({
  ...
  standalone: true,
  imports: [MatCard, MatCardTitle, ReactiveFormsModule, MatProgressSpinner, MatFormField, MatLabel, MatOption, MatSelect, NgIf, DatosPerfilComponent, CommonModule, HistoriaClinicaFormComponent],
...
export class MiPerfilComponent {
  ...
  horarios : any[] = [];
  form!: FormGroup; 
  constructor(private auth: FirebaseAuthService,private firestore:FirestoreService,private formBuilder:FormBuilder){
